...
export const KNOWLEDGE_QUIZZES = [
  ...
  { statement: 'ABC 瘦身法建議每天至少吃三餐', answer: false, explain: '重點不是幾餐，是每餐的品質。有人兩餐就夠，有人需要三餐，聽身體的 🕐', category: 'abc', tier: 2 },
  ...
  { statement: '椰子油是中鏈脂肪酸，可以快速被身體利用', answer: true, explain: '中鏈脂肪酸不需要膽汁分解，直接送到肝臟轉換成能量 🥥', category: 'nutrition', tier: 2 },
  ...
  // Tier 3
  { statement: '血中大部分飽和脂肪來自飲食中的油脂', answer: false, explain: '其實大部分來自肝臟脂質新生，因為碳水吃太多，肝臟把多餘的糖轉成脂肪 🧪', category: 'nutrition', tier: 3 },
  ...
  // Tier 3
  { statement: '減肥是一輩子的事，不是一個階段', answer: true, explain: '建立好的飲食習慣是一輩子的事。不是「減完」就回到以前，而是活出新的自己 🌟', category: 'mindset', tier: 3 },
  ...
  { statement: '每天量體重對減肥有幫助', answer: false, explain: '每天量容易被數字綁架。建議一週量一次，固定時間，觀察趨勢就好 📊', category: 'behavior', tier: 1 },
  ...
  { statement: '運動後 30 分鐘內一定要吃東西', answer: false, explain: '一般人不需要急著補。除非是高強度運動員，否則正常吃下一餐就好 🏋️', category: 'behavior', tier: 2 },
