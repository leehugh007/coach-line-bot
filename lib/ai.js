...
**isAchievement（心得/成果分享）**
學員在分享進步、改變、感受、里程碑 → isAchievement = true。
這是教練出場稱讚鼓勵的好時機，也讓其他學員看到真實成果。
- 體重/體態改變：「瘦了X公斤」「褲子穿得下了」「體檢數字沒有紅字了」
...
- 純打卡：「今天吃了XX」「走了8000步」（只是說明今天做了什麼，沒有表達改變或感受）
