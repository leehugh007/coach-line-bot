...
export const QUIZ_LEVELS = [
  ...
  { min: 20, title: '分類學徒', emoji: '⭐', next: '再認識 {n} 種就升級' },
  { min: 50, title: '營養達人', emoji: '🏆', next: '再認識 {n} 種就升級' },
  { min: 100, title: '食物專家', emoji: '💎', next: '再認識 {n} 種就升級' },
  { min: 150, title: '分類大師', emoji: '👑', next: '再認識 {n} 種就升級' },
  { min: 200, title: '全制霸', emoji: '🎖️', next: '你已經是最高等級了！' },
];
...
export const FOOD_QUIZZES = [
  ...
  // --- 原有 34 題中的澱粉題 ---
  { food: '南瓜', optA: '蔬菜', optB: '澱粉', correct: '澱粉', explain: '南瓜、玉米、蓮藕、山藥、芋頭都是澱粉，不是蔬菜 😄', category: 'starch-disguise' },
  ...
  { food: '麻糬', optA: '蛋白質', optB: '澱粉', correct: '澱粉', explain: '麻糬是糯米做的純澱粉，而且黏性高消化慢，容易不知不覺吃太多 😄', category: 'starch-disguise' },
  { food: '年糕', optA: '蛋白質', optB: '澱粉', correct: '澱粉', explain: '年糕是糯米做的澱粉！過年吃一塊兩塊可以，不要當零食吃 😄', category: 'starch-disguise' },
  { food: '米苔目', optA: '蔬菜', optB: '澱粉', correct: '澱粉', explain: '米苔目是米做的澱粉！湯米苔目看起來清淡，但其實一碗就是一碗飯 😄', category: 'starch-disguise' },
  { food: '粿仔條', optA: '蔬菜', optB: '澱粉', correct: '澱粉', explain: '粿仔條是米製品，就是澱粉。炒粿仔條還會再加一堆油 😄', category: 'starch-disguise' },
  { food: '意麵', optA: '蛋白質', optB: '澱粉', correct: '澱粉', explain: '意麵是油炸過的麵條，澱粉+油脂雙重炸彈，少吃為妙 😮', category: 'starch-disguise' },
  { food: '油麵', optA: '蛋白質', optB: '澱粉', correct: '澱粉', explain: '油麵就是拌了油的麵條，澱粉+油，熱量比白飯還高 😄', category: 'starch-disguise' },
  { food: '河粉', optA: '蔬菜', optB: '澱粉', correct: '澱粉', explain: '河粉是米漿做的，純澱粉！炒河粉又再加一堆油 😄', category: 'starch-disguise' },
  { food: '粄條', optA: '蔬菜', optB: '澱粉', correct: '澱粉', explain: '粄條跟河粉類似，都是米做的澱粉，客家粄條湯看起來清淡但澱粉量不少 😄', category: 'starch-disguise' },
  ...
  { food: '碗粿', optA: '蛋白質', optB: '澱粉', correct: '澱粉', explain: '碗粿是在來米漿蒸的，純澱粉！上面的料只是配角 😄', category: 'starch-disguise' },
  ...
  { food: '饅頭', optA: '蛋白質', optB: '澱粉', correct: '澱粉', explain: '饅頭是麵粉蒸的，一個饅頭 ≈ 一碗飯的澱粉量 😄', category: 'starch-disguise' },
  ...
  { food: '蔥油餅', optA: '蔬菜', optB: '澱粉', correct: '澱粉', explain: '蔥油餅是麵粉+油煎的，澱粉+油脂雙炸彈 😮', category: 'starch-disguise' },
  { food: '春捲皮', optA: '蔬菜', optB: '澱粉', correct: '澱粉', explain: '春捲皮是麵粉做的澱粉，看起來薄薄的但積少成多 😄', category: 'starch-disguise' },
  ...
  // --- 新增蛋白質題 ---
  { food: '雞胸肉', optA: '蛋白質', optB: '油脂', correct: '蛋白質', explain: '雞胸肉是最經典的低脂高蛋白食材，減脂好朋友 💪', category: 'protein' },
  { food: '雞腿肉', optA: '蛋白質', optB: '油脂', correct: '蛋白質', explain: '雞腿肉帶皮油脂較高，去皮後就是不錯的蛋白質來源 😄', category: 'protein' },
  { food: '豬里肌', optA: '蛋白質', optB: '油脂', correct: '蛋白質', explain: '豬里肌是豬肉中最瘦的部位，蛋白質含量高，是好選擇 💪', category: 'protein' },
  { food: '牛腱', optA: '蛋白質', optB: '油脂', correct: '蛋白質', explain: '牛腱是低脂肪的牛肉部位，滷牛腱是很好的蛋白質來源 💪', category: 'protein' },
  { food: '鮭魚', optA: '蛋白質', optB: '油脂', correct: '蛋白質', explain: '鮭魚主要是蛋白質，雖然含 Omega-3 好油，但歸類在蛋白質 😄', category: 'protein' },
  { food: '鯖魚', optA: '蛋白質', optB: '油脂', correct: '蛋白質', explain: '鯖魚富含 Omega-3 和蛋白質，是很好的魚類選擇 💪', category: 'protein' },
  { food: '蝦仁', optA: '蛋白質', optB: '蔬菜', correct: '蛋白質', explain: '蝦仁是高蛋白低脂的好食材，不用怕膽固醇 💪', category: 'protein' },
  { food: '蛤蜊', optA: '蛋白質', optB: '蔬菜', correct: '蛋白質', explain: '蛤蜊是低脂高蛋白的海鮮，蛤蜊湯超適合減脂期喝 😄', category: 'protein' },
  { food: '花枝', optA: '蛋白質', optB: '油脂', correct: '蛋白質', explain: '花枝是低脂高蛋白的海鮮，但炸花枝就不一樣了 😄', category: 'protein' },
  { food: '鮪魚罐頭', optA: '蛋白質', optB: '油脂', correct: '蛋白質', explain: '水煮鮪魚罐頭是方便的蛋白質來源，選水煮的，不要選油漬的 😄', category: 'protein' },
  { food: '雞蛋', optA: '蛋白質', optB: '油脂', correct: '蛋白質', explain: '雞蛋是完全蛋白質，蛋黃的脂肪是好油，不用怕吃全蛋 💪', category: 'protein' },
  { food: '鴨蛋', optA: '蛋白質', optB: '油脂', correct: '蛋白質', explain: '鴨蛋跟雞蛋一樣是蛋白質，營養組成差不多 😄', category: 'protein' },
  { food: '皮蛋', optA: '蛋白質', optB: '油脂', correct: '蛋白質', explain: '皮蛋是加工過的鴨蛋，一樣是蛋白質，偶爾吃沒問題 😄', category: 'protein' },
  ...
  { food: '鮮奶', optA: '蛋白質', optB: '油脂', correct: '蛋白質', explain: '鮮奶是蛋白質+鈣質的好來源，全脂鮮奶的脂肪不用怕 😄', category: 'protein' },
  ...
  { food: '蘇打餅', optA: '澱粉', optB: '油脂', correct: '油脂', explain: '蘇打餅看起來清淡，其實油脂含量比你想的高不少 😮', category: 'fat' },
  ...
  // --- 原有蔬菜題 ---
  { food: '蘿蔔', optA: '蔬菜', optB: '澱粉', correct: '蔬菜', explain: '白蘿蔔是蔬菜沒錯，但紅蘿蔔吃多了也要注意醣分 😄', category: 'vegetable' },
  ...
  // --- 新增蔬菜題 ---
  { food: '花椰菜', optA: '蔬菜', optB: '澱粉', correct: '蔬菜', explain: '花椰菜是超級蔬菜！低熱量高纖維，切碎還能當飯替代品 💪', category: 'vegetable' },
  { food: '青花菜', optA: '蔬菜', optB: '蛋白質', correct: '蔬菜', explain: '青花菜是蔬菜，蛋白質含量在蔬菜中算高的，營養超好 💪', category: 'vegetable' },
  { food: '空心菜', optA: '蔬菜', optB: '澱粉', correct: '蔬菜', explain: '空心菜是蔬菜，清炒空心菜是便當的好選擇 😄', category: 'vegetable' },
  { food: '地瓜葉', optA: '蔬菜', optB: '澱粉', correct: '蔬菜', explain: '地瓜葉是蔬菜！不要跟地瓜搞混了，地瓜才是澱粉 😄', category: 'vegetable' },
  { food: '菠菜', optA: '蔬菜', optB: '蛋白質', correct: '蔬菜', explain: '菠菜是營養豐富的蔬菜，鐵質含量高，安心吃 😄', category: 'vegetable' },
  { food: '高麗菜', optA: '蔬菜', optB: '澱粉', correct: '蔬菜', explain: '高麗菜是蔬菜，生菜沙拉或清炒都很好 😄', category: 'vegetable' },
  { food: '大白菜', optA: '蔬菜', optB: '澱粉', correct: '蔬菜', explain: '大白菜是低熱量蔬菜，火鍋裡多放一些取代加工品 😄', category: 'vegetable' },
  ...
  { food: '苦瓜', optA: '蔬菜', optB: '澱粉', correct: '蔬菜', explain: '苦瓜是蔬菜，對血糖調控也有幫助，雖然很多人怕苦 😄', category: 'vegetable' },
  { food: '絲瓜', optA: '蔬菜', optB: '澱粉', correct: '蔬菜', explain: '絲瓜是蔬菜，絲瓜蛤蜊湯是很棒的低卡組合 😄', category: 'vegetable' },
  { food: '冬瓜', optA: '蔬菜', optB: '澱粉', correct: '蔬菜', explain: '冬瓜是蔬菜，幾乎都是水分，熱量超低 😄', category: 'vegetable' },
  { food: '小黃瓜', optA: '蔬菜', optB: '水果', correct: '蔬菜', explain: '小黃瓜是蔬菜，熱量極低又有飽足感，減脂好幫手 💪', category: 'vegetable' },
  { food: '竹筍', optA: '蔬菜', optB: '澱粉', correct: '蔬菜', explain: '竹筍是蔬菜，高纖低卡，涼拌竹筍很適合夏天 😄', category: 'vegetable' },
  ...
  { food: '蘆筍', optA: '蔬菜', optB: '蛋白質', correct: '蔬菜', explain: '蘆筍是蔬菜，營養價值很高，清炒或水煮都棒 😄', category: 'vegetable' },
  { food: '韭菜', optA: '蔬菜', optB: '澱粉', correct: '蔬菜', explain: '韭菜是蔬菜，但韭菜水餃的皮是澱粉要注意 😄', category: 'vegetable' },
  ...
  { food: '蘋果', optA: '水果', optB: '澱粉', correct: '水果', explain: '蘋果是很好的水果選擇，帶皮吃纖維更多 😄', category: 'fruit' },
  ...
  { food: '柳丁', optA: '水果', optB: '蔬菜', correct: '水果', explain: '柳丁是水果，吃整顆的比喝柳丁汁好太多 😄', category: 'fruit' },
  { food: '橘子', optA: '水果', optB: '蔬菜', correct: '水果', explain: '橘子是水果，一次一顆剛好，不要一口氣吃一整袋 😄', category: 'fruit' },
  ...
  { food: '鳳梨', optA: '水果', optB: '蔬菜', correct: '水果', explain: '鳳梨酵素幫助消化，但糖分偏高，控制在一碗切片 😄', category: 'fruit' },
  { food: '百香果', optA: '水果', optB: '蔬菜', correct: '水果', explain: '百香果本身糖分不算太高，但很多人會加很多糖或蜂蜜 😄', category: 'fruit' },
  { food: '火龍果', optA: '水果', optB: '蔬菜', correct: '水果', explain: '火龍果含天然色素和纖維，但糖分也不少，適量吃 😄', category: 'fruit' },
  { food: '草莓', optA: '水果', optB: '蔬菜', correct: '水果', explain: '草莓是低糖水果好選擇，但草莓煉乳就不行了 😄', category: 'fruit' },
  { food: '藍莓', optA: '水果', optB: '蔬菜', correct: '水果', explain: '藍莓抗氧化超強，是很好的水果選擇，一小碗就好 😄', category: 'fruit' },
  { food: '櫻桃', optA: '水果', optB: '蔬菜', correct: '水果', explain: '櫻桃糖分偏高，看起來小小的但一把就是一份水果 😄', category: 'fruit' },
  { food: '榴槤', optA: '水果', optB: '油脂', correct: '水果', explain: '榴槤是水果但熱量超高！糖分+油脂都高，一小塊就好 😮', category: 'fruit' },
  { food: '柚子', optA: '水果', optB: '蔬菜', correct: '水果', explain: '柚子是水果，纖維豐富但一瓣瓣容易不知不覺吃太多 😄', category: 'fruit' },
  ...
  { food: '有糖豆漿', optA: '蛋白質', optB: '澱粉', correct: '澱粉', explain: '有糖豆漿加了糖就變成澱粉+蛋白質的混合體，盡量選無糖的 😄', category: 'beverage' },
  { food: '拿鐵', optA: '蛋白質', optB: '油脂', correct: '蛋白質', explain: '無糖拿鐵主要是牛奶+咖啡，算蛋白質+少許油脂 😄', category: 'beverage' },
  { food: '黑咖啡', optA: '蔬菜', optB: '水果', correct: '蔬菜', explain: '黑咖啡幾乎零熱量，跟水差不多，放心喝 😄（硬要分的話算植物萃取）', category: 'beverage' },
  ...
  // 調味料/醬料系列
  // ============================================================
  { food: '醬油', optA: '蛋白質', optB: '澱粉', correct: '蛋白質', explain: '醬油是黃豆發酵的，鈉含量高但熱量低，主要注意鹹度就好 😄', category: 'sauce' },
  ...
  // 補充題 — 飲品
  // ============================================================
  { food: '紅茶（無糖）', optA: '蔬菜', optB: '水果', correct: '蔬菜', explain: '無糖紅茶幾乎零熱量，跟水差不多，放心喝 😄', category: 'beverage' },
  { food: '綠茶（無糖）', optA: '蔬菜', optB: '水果', correct: '蔬菜', explain: '無糖綠茶零熱量還有兒茶素，是好飲品 😄', category: 'beverage' },
