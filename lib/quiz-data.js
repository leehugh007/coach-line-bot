...
export const QUIZ_LEVELS = [
  ...
  { min: 90, title: '食物專家', emoji: '💎', next: '再認識 {n} 種就升級' },
  { min: 130, title: '分類大師', emoji: '👑', next: '再認識 {n} 種就升級' },
  { min: 170, title: '全制霸', emoji: '🎖️', next: '你已經是最高等級了！' },
];
...
export const FOOD_QUIZZES = [
  ...
  { food: '珍珠（粉圓）', optA: '蛋白質', optB: '澱粉', correct: '澱粉', explain: '珍珠是樹薯粉做的純澱粉！一杯珍奶的珍珠就等於大半碗飯 😱', category: 'starch-disguise' },
  { food: '年糕', optA: '蔬菜', optB: '澱粉', correct: '澱粉', explain: '年糕是糯米做的澱粉！過年吃一塊兩塊可以，不要當零食吃 😄', category: 'starch-disguise' },
  { food: '意麵', optA: '蛋白質', optB: '澱粉', correct: '澱粉', explain: '意麵是油炸過的麵條，澱粉+油脂雙重組合。選冬粉、米粉或乾麵條更好 😄', category: 'starch-disguise' },
  ...
  { food: '蘇打餅', optA: '澱粉', optB: '油脂', correct: '澱粉', explain: '蘇打餅主要原料是麵粉，是澱粉類。而且油脂含量比你想的高不少，少量當零食還行 😮', category: 'starch-disguise' },
  ...
  { food: '奶油', optA: '澱粉', optB: '油脂', correct: '油脂', explain: '奶油就是純油脂，塗吐司一小塊就快 100 大卡了 😄', category: 'fat' },
  ...
  { food: '黑糖', optA: '澱粉', optB: '油脂', correct: '澱粉', explain: '黑糖就是糖！礦物質含量微乎其微，不要被「養生」標籤騙了 😮', category: 'sauce' },
  { food: '果糖（糖漿）', optA: '水果', optB: '澱粉', correct: '澱粉', explain: '手搖飲的果糖是玉米糖漿，跟水果完全無關，對肝臟負擔很大 😮', category: 'sauce' },
  { food: '楓糖漿', optA: '油脂', optB: '澱粉', correct: '澱粉', explain: '楓糖漿就是糖！天然來源不代表不是糖，對血糖影響一樣大 😮', category: 'sauce' },
  ...
  // 補充題 — 油脂
  // ============================================================
  { food: '椰子油', optA: '蛋白質', optB: '油脂', correct: '油脂', explain: '椰子油就是純油脂，中鏈脂肪酸的好處不代表可以無限吃 😄', category: 'fat' },
  { food: '豬油', optA: '澱粉', optB: '油脂', correct: '油脂', explain: '豬油是純油脂，拌飯拌麵一小匙就超過 100 大卡 😄', category: 'fat' },

  // ============================================================
  // 新增 29 題 — 2026-03-28（出題 Skill 產出）
  // ============================================================

  // --- 台灣小吃/街食 ---
  { food: '蔥油餅', optA: '蔬菜', optB: '澱粉', correct: '澱粉', explain: '蔥油餅的蔥只是提味，主體是麵粉揉油做的餅皮，澱粉+油脂的組合，一片就等於一碗飯加兩匙油 😮', category: 'processed' },
  { food: '碗粿', optA: '蛋白質', optB: '澱粉', correct: '澱粉', explain: '碗粿是在來米漿做的，主體就是澱粉，上面的配料只是點綴 😄', category: 'processed' },
  { food: '筒仔米糕', optA: '蛋白質', optB: '澱粉', correct: '澱粉', explain: '筒仔米糕是糯米做的，就是澱粉！配料的肉和香菇只占一小部分 😄', category: 'processed' },
  { food: '鹹粥', optA: '蛋白質', optB: '澱粉', correct: '澱粉', explain: '鹹粥的主角是米（澱粉），配料的魚肉蛋雖然有蛋白質，但整碗還是以澱粉為主 😄', category: 'processed' },
  { food: '四神湯', optA: '蛋白質', optB: '澱粉', correct: '澱粉', explain: '四神湯裡的薏仁、蓮子、山藥、芡實都是澱粉類！豬腸只是配料，主體是碗澱粉湯 😮', category: 'processed' },

  // --- 早餐 ---
  { food: '鐵板麵', optA: '蛋白質', optB: '澱粉', correct: '澱粉', explain: '鐵板麵是油麵+勾芡醬汁，澱粉+油+糖的組合，一份就快 500 大卡 😮', category: 'processed' },
  { food: '飯糰', optA: '蛋白質', optB: '澱粉', correct: '澱粉', explain: '飯糰主體是糯米（澱粉），裡面還包油條（也是澱粉+油），一顆就超過一碗半的飯量 😮', category: 'processed' },
  { food: '燒餅', optA: '蛋白質', optB: '澱粉', correct: '澱粉', explain: '燒餅是麵粉加油酥烤出來的，就是澱粉+油脂，酥酥的口感全靠油 😄', category: 'processed' },
  { food: '油飯', optA: '蛋白質', optB: '澱粉', correct: '澱粉', explain: '油飯是糯米用麻油拌炒的，主體是澱粉，油脂量也不低，一碗就超過 500 大卡 😮', category: 'processed' },

  // --- 火鍋料 ---
  { food: '蟹味棒', optA: '蛋白質', optB: '澱粉', correct: '澱粉', explain: '蟹味棒裡完全沒有螃蟹！是魚漿+澱粉+色素做的，澱粉含量不低 😮', category: 'processed' },
  { food: '王子麵', optA: '蛋白質', optB: '澱粉', correct: '澱粉', explain: '王子麵就是油炸過的麵條，澱粉+油脂的組合，火鍋丟一包等於多吃大半碗飯 😄', category: 'processed' },
  { food: '魚板', optA: '蛋白質', optB: '澱粉', correct: '澱粉', explain: '魚板雖然有魚漿，但加了大量澱粉，碳水化合物比蛋白質還多 😮', category: 'processed' },
  { food: '火鍋豆皮（炸）', optA: '蛋白質', optB: '油脂', correct: '油脂', explain: '火鍋用的炸豆皮吸滿了油，跟生豆皮完全不同！放進湯裡又會吸更多油 😮', category: 'fat' },

  // --- 水果 ---
  { food: '蓮霧', optA: '水果', optB: '蔬菜', correct: '水果', explain: '蓮霧是低糖高水分的水果，減脂期是很棒的水果選擇！一顆熱量才 30 大卡左右 💪', category: 'fruit' },
  { food: '柿子', optA: '水果', optB: '澱粉', correct: '水果', explain: '柿子是水果但糖分很高！維生素含量是一般水果的 1-2 倍，吃半顆到一顆就好 😄', category: 'fruit' },
  { food: '百香果', optA: '水果', optB: '蔬菜', correct: '水果', explain: '百香果是低 GI 水果，纖維很高，酸酸的但其實糖分不算低，兩三顆就是一份水果 😄', category: 'fruit' },
  { food: '火龍果', optA: '水果', optB: '蔬菜', correct: '水果', explain: '火龍果是水果，纖維高助排便，但糖分也不低，半顆就算一份水果了 😄', category: 'fruit' },

  // --- 調味料/醬料 ---
  { food: '辣椒醬', optA: '蔬菜', optB: '油脂', correct: '油脂', explain: '辣椒醬通常是辣椒用大量的油炒製的，主要熱量來自油脂，一匙油量不少 😄', category: 'sauce' },
  { food: '醬油膏', optA: '蛋白質', optB: '澱粉', correct: '澱粉', explain: '醬油膏是醬油加了澱粉和糖增稠的，比醬油多了不少糖分，沾一點點就好 😄', category: 'sauce' },
  { food: '素蠔油', optA: '蛋白質', optB: '澱粉', correct: '澱粉', explain: '素蠔油是香菇+醬油+澱粉+糖做的，雖然叫「油」但主要隱藏的是糖和澱粉 😄', category: 'sauce' },
  { food: '沙拉油', optA: '澱粉', optB: '油脂', correct: '油脂', explain: '沙拉油就是純油脂，炒菜用一大匙就超過 100 大卡。選酪梨油或橄欖油更好 😄', category: 'sauce' },

  // --- 蛋白質來源 ---
  { food: '鴨肉', optA: '蛋白質', optB: '油脂', correct: '蛋白質', explain: '鴨肉是蛋白質，去皮的鴨胸脂肪不高，薑母鴨的油是湯底加的不是鴨肉本身 💪', category: 'protein' },
  { food: '羊肉', optA: '蛋白質', optB: '油脂', correct: '蛋白質', explain: '羊肉是蛋白質，選瘦的部位脂肪不高，羊肉爐的油主要來自湯底和油花 😄', category: 'protein' },
  { food: '蝦子', optA: '蛋白質', optB: '油脂', correct: '蛋白質', explain: '蝦子是高蛋白低脂肪的好選擇！水煮、清蒸都很棒 💪', category: 'protein' },
  { food: '蛤蜊', optA: '蛋白質', optB: '蔬菜', correct: '蛋白質', explain: '蛤蜊是低脂高蛋白的海鮮，蛤蜊湯鮮甜又低卡，是外食的好選擇 💪', category: 'protein' },
  { food: '干貝', optA: '蛋白質', optB: '油脂', correct: '蛋白質', explain: '干貝幾乎是純蛋白質，脂肪含量極低，是很優質的蛋白質來源 💪', category: 'protein' },
  { food: '鴨血', optA: '蛋白質', optB: '油脂', correct: '蛋白質', explain: '鴨血跟豬血一樣是高蛋白低脂肪，火鍋加鴨血比加王子麵好太多了 💪', category: 'protein' },

  // --- 容易搞混的澱粉偽裝 ---
  { food: '米苔目', optA: '蛋白質', optB: '澱粉', correct: '澱粉', explain: '米苔目是在來米做的，就是澱粉！加了糖水更是甜澱粉，鹹的湯版本好一些 😄', category: 'starch-disguise' },
  { food: '粉條', optA: '蔬菜', optB: '澱粉', correct: '澱粉', explain: '粉條是地瓜粉或樹薯粉做的，跟冬粉一樣看起來透明但就是澱粉 😄', category: 'starch-disguise' },
];
