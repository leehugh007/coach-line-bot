...
// ===================================================================
// 防流失問題診斷型訊息（讓學員說出心裡話，比知識題更能引發對話）
// 依據沉默天數（7-13 / 14-20 / 21+）× 課程階段（early/mid/late）分版本
// ===================================================================

function getChurnPreventionMessage(daysSilent, name, courseWeek) {
  const stage = courseWeek <= 3 ? 'early' : courseWeek <= 6 ? 'mid' : 'late';
